...
<tbody>
	...
	<td><form target="_blank" action='./stampa_scheda_ass.php' method='POST'>
		</td>		
		<td width='10'>ID*:</td>
...
<!-- Creo la combo -->
              <td><input name='associato' size='10' type='text' value='<? echo $idprec ?>' readonly ></td>
...
<table align='center' border='0' cellpadding='0' cellspacing='2' width='90%'>
	...
	<tr><td width='150'><small><b>Socio attivo </b></small></td>	<td width='150'><input type="submit" name="attivo" value="$row[associato]">
