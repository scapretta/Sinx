...
<?php
// $classe = $_POST['classi'];
$Query_nome = "SELECT * FROM tb_anagrafe WHERE tipologia != 'Extra' AND associato = 'si' ORDER BY $ordine";
...
<table align='center' border='0' cellpadding='0' cellspacing='2' width='90%'>
	...
	<td width='10%'><small><b>$Lfunzione</b></small></td>
...
echo <<<EOM
	...
	<td ><small>$row[materia]</small></td>
	<td ><small>$row[classe]</small></td>
