...
$tb_anagrafe = ('tb_anagrafe(nome, cognome, indirizzo, cap, citta, provincia, tel, tel2, materia, email, nomerif, datan, tipologia, note, immagine, associato)');
	if ($nome){ 
		$sql="insert into $tb_anagrafe values('$tessera', '$nome', '$cognome', '$indirizzo', '$cap', '$citta', '$provincia', '$tel', '$tel2', '$materia', '$email', '$nomerif', '$datan', 'Ins', '$note', '$file_name','$associato')"; //inserisco i valori nel database
