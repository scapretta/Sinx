...
/*======================================================================+
 File name   : InsAnagrFile.inc
 Begin       : 2017-12-08
 Last Update : 2017-12-08

 Description : Anagrafica da csv
...
<hr style="width: 80%; height: 2px;">
      <form action='./conf_importacsv.php' method='POST' enctype="multipart/form-data">
	    ...
	    <tr>
	      ...
	      <td> <input name="filecsv" type="file" required="true">
                  <br><sub><i><?php echo $Lsugg1caricafiles; echo $Lsugg2caricafiles; ?></i></sub>
              </td>
...
<?php
include('./menusx.inc');
?><hr><img src='./Immagini/suggerimento.png'><small><i><?php echo $LNota ?><hr></i></small>
